            ...
            <div class="col-lg-5">
                <div class="hive_affiliatebanner__right">
                    <div class="hive_affiliatebanner__thumb wow zoomIn" data-wow-delay=".3s">
                        <img src="<?php echo get_template_directory_uri() ?>/assets/img/affiliate/affiliateBanner.png" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row gy-5">
                ...
                <div class="hive_affiliatePromo white">
                    <div class="hive_affiliatePromo__flex">
                        <div class="hive_affiliatePromo__thumb">
                            <img src="<?php echo get_template_directory_uri() ?>/assets/img/affiliate/affiliatePromo1.png" alt="icon">
                        </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="hive_affiliatePromo white">
                    <div class="hive_affiliatePromo__flex">
                        <div class="hive_affiliatePromo__thumb">
                            <img src="<?php echo get_template_directory_uri() ?>/assets/img/affiliate/affiliatePromo2.png" alt="icon">
                        </div>
                        <div class="hive_affiliatePromo__contents">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="hive_affiliatePromo white">
                    <div class="hive_affiliatePromo__flex">
                        <div class="hive_affiliatePromo__thumb">
                            <img src="<?php echo get_template_directory_uri() ?>/assets/img/affiliate/affiliatePromo3.png" alt="icon">
                        </div>
                        <div class="hive_affiliatePromo__contents">
    ...
    <div class="container">
        ...
        <div class="row gy-5 mt-2">
            <div class="col-lg-4 col-sm-6">
                <div class="hive_affiliateWork center-text">
                    <div class="hive_affiliateWork__thumb">
                        <img src="<?php echo get_template_directory_uri() ?>/assets/img/affiliate/affiliateWork1.png" alt="icon">
                    </div>
            ...
            <div class="col-lg-4 col-sm-6">
                <div class="hive_affiliateWork center-text">
                    <div class="hive_affiliateWork__thumb">
                        <img src="<?php echo get_template_directory_uri() ?>/assets/img/affiliate/affiliateWork2.png" alt="icon">
                    </div>
                    <div class="hive_affiliateWork__contents mt-4">
            ...
            <div class="col-lg-4 col-sm-6">
                <div class="hive_affiliateWork center-text">
                    <div class="hive_affiliateWork__thumb">
                        <img src="<?php echo get_template_directory_uri() ?>/assets/img/affiliate/affiliateWork3.png" alt="icon">
                    </div>
                    <div class="hive_affiliateWork__contents mt-4">
                        <h4 class="hive_affiliateWork__title">Get a unique link</h4>
                        <p class="hive_affiliateWork__para mt-2">You can get paid once your earning is $100 only</p>
